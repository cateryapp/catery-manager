...
-- Grant usage to public (or specific roles) so they can use the functions
GRANT USAGE ON SCHEMA extensions TO postgres, anon, authenticated, service_role;

-- Ensure public can use it or add to search path? 
-- Better to just qualify or add to search path.
-- We will rely on qualified, or search path.
